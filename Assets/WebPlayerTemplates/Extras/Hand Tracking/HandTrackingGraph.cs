...
namespace Mediapipe.Unity.HandTracking
{
  public class HandTrackingGraph : GraphRunner
  {
    ...
    /* */public const string _HandLandmarksStreamName = "hand_landmarks";
    ...
    /* */public OutputStream<NormalizedLandmarkListVectorPacket, List<NormalizedLandmarkList>> _handLandmarksStream;
    ...
    /**/ public SidePacket BuildSidePacket(ImageSource imageSource)
    {
